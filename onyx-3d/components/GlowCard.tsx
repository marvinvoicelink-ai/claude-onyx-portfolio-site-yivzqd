...
export default function GlowCard({ children }: { children: ReactNode }) {
  return (
    <div
      ...
      style={{
        background:
          "linear-gradient(160deg, rgba(232,163,61,0.07) 0%, rgba(17,17,17,0) 55%), var(--near-black-2)",
        border: "1px solid rgba(232,163,61,0.32)",
        boxShadow:
          "0 0 0 1px rgba(232,163,61,0.06), 0 0 34px -6px rgba(232,163,61,0.3), 0 18px 50px -24px rgba(0,0,0,0.85)",
      }}
    >
      {children}
    </div>
