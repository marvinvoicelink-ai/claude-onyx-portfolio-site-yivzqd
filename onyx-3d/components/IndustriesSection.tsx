    ...
    <section className="py-14 relative overflow-hidden">
      ...
      <div className="mx-auto px-7 text-center" style={{ maxWidth: 1180 }}>
        ...
        <p className="mx-auto" style={{ color: "var(--warm-grey-dim)", maxWidth: "62ch", fontSize: "1.02rem", lineHeight: 1.7, marginBottom: 40 }}>
          Wir bauen für mittelständische Unternehmen, die aus Excel-Tabellen,
          Zetteln und verstreuten Tools rauswollen — vom Handwerksbetrieb bis
          zur Personaldienstleistung. Ob Aufmaß direkt auf der Baustelle,
          Kundenportal für die Verwaltung oder Dashboard für den Vertrieb:
          dein Prozess entscheidet, nicht eine Vorlage.
        </p>
