...
2. **Übersicht.** Eine Frist ist überschritten, ein Ortstermin steht an. Das ist
   der Aufhänger: das System meldet sich, bevor es eng wird.
3. **Objekte.** Zwischen Liste und Kacheln umschalten, nach „Wardenburg“ suchen,
   nach Status oder Auftraggeber filtern.
...
- **Liste und Kacheln.** Liste als dichtes Register, Kacheln mit Titelfoto.
  Volltextsuche plus Filter nach Status und Auftraggeber, alles in der Adresszeile.
...
- **Von überall nutzbar.** Responsiv von 360 px bis Desktop, am Handy mit
  Bedienleiste in Daumenreichweite. Hell- und Dunkelmodus.
